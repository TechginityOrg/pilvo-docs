...
<div class="notice-box-response">
  <p><strong>Note:</strong> The default rate limit for this API is 20 requests per minute. If the rate limit is exceeded, the following error would be thrown: "too many requests"</p>
</div>
  #### API Endpoint
